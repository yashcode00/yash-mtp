...
output_main="${log_dir}displace-terminator-eval-48000-0.25.log"
...
python3 /nlsasfs/home/nltm-st/sujitk/yash-mtp/src/evaluate/languageDiarizer-fast.py &> "$output_main" &
