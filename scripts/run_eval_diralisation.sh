...
output_main="${log_dir}displace-eval-32000-0.25-11lang-final-synthticdata.log"
...
python /nlsasfs/home/nltm-st/sujitk/yash-mtp/src/evaluate/languageDiarizer-fast.py &> "$output_main" &
