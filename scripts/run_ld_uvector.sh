...
output_main="${log_dir}spring-wave2vec2-2lang--real-48000-0.25-20-50-displace.log"
...
python3 /nlsasfs/home/nltm-st/sujitk/yash-mtp/src/evaluate/languageDiarizer-fast-uvector-springLabs.py &> "$output_main" &
