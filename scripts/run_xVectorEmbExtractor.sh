...
log_dir="/nlsasfs/home/nltm-st/sujitk/yash-mtp/logs/plots/"
output_main="${log_dir}xvector-emb.log"
...
python /nlsasfs/home/nltm-st/sujitk/yash-mtp/src/tdnn/xVectorExtractor.py &> "$output_main" &
