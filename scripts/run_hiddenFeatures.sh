...
output_main="${log_dir}combined-hiddeFeatrues-newone-2sec-12lang.log"
...
python /nlsasfs/home/nltm-st/sujitk/yash-mtp/src/tdnn/fasterHiddenFeatures-ddp.py &> "$output_main" &
