...
output_main="${log_dir}displaced-terminator-finetunON2lang-300m-on-dev-audioFromRTTM.log"
...
python /nlsasfs/home/nltm-st/sujitk/yash-mtp/src/wav2vec2/main_v1_1_temp.py &> "$output_main" &
