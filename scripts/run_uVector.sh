...
output_main="${log_dir}uvector-displace-2-lang-2.log"
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m torch.distributed.launch --nproc_per_node=5 /nlsasfs/home/nltm-st/sujitk/yash-mtp/src/uVector/uVectorTraining-ddp.py &> "$output_main" &
