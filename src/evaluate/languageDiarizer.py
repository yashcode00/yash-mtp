...
resultDERPath = "/nlsasfs/home/nltm-st/sujitk/NNDL"
...
audioPath = "/nlsasfs/home/nltm-st/sujitk/NNDL/audio"
...
### Intializing models
## for wave2vec2
model_name_or_path = "/nlsasfs/home/nltm-st/sujitk/NNDL/wav2vec2-large-xlsr-indian-language-classification-featureExtractor"
...
def generate_rttm_file(name,cp, predicted_labels, total_time):
    print("called generate_rttm_file")
    rttm_content = ""
...
def numeric_part(filename):
    print("called numeric_part")
    return int(''.join(filter(str.isdigit, filename)))

def findCumulativeDER():
    print("called findCumulativeDER")
