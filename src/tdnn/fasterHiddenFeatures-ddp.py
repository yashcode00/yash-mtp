...
# saved_dataset_path =  "/nlsasfs/home/nltm-st/sujitk/yash-mtp/datasets/wav2vec2/displace-saved-dataset.hf"
...
class HiddenFeatureExtractor:
    def __init__(self, data: DataLoader, gpu_id: int) -> None:
        ...
        self.model_name_or_path = "/nlsasfs/home/nltm-st/sujitk/yash-mtp/models/Phase2/wave2vec2-2lang-finetunedOnrttm_300M-saved-model_20240416_010420/pthFiles/modelinfo_epoch_6"
        self.cache_dir = "/nlsasfs/home/nltm-st/sujitk/yash-mtp/cache"
        self.hiddenFeaturesPath = "/nlsasfs/home/nltm-st/sujitk/yash-mtp/datasets/Phase2"
        self.givenName = "wave2vec2-2lang-hiddenFeatures-fast"
        ...
        # self.processed_dataset_givenName = "combined-saved-dataset-12lang-new-2snec-processed.hf"
