...
#SBATCH --output=/nlsasfs/home/nltm-st/sujitk/yash-mtp/logs/wav2vec2/output.log  # Updated output path
#SBATCH --error=/nlsasfs/home/nltm-st/sujitk/yash-mtp/logs/wav2vec2/error.log    # Updated error path
...
output_main="${log_dir}output.log"
